        ...
        <div class="row">
            ...
            <div class="col-sm-7 form-box">
                ...
                <div class="form-top">
                   ...
                   <%--<div class="form-top-right" style="margin-top:20px; margin-left:-70px;">  
                 <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/LoginPage.aspx"><h2 style="color:darkmagenta;"><b>Login!</b></h2></asp:HyperLink>
