<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master"
    ...
    CodeBehind="AdminHomePage.aspx.cs"
    Inherits="Project_Fall2015_SilentAunctionPro.PagesAdmin.AdminHomePage" %>
                ...
                <ContentTemplate>
                    ...
                    <asp:MultiView ID="userview" ActiveViewIndex="0" runat="server">
                        <asp:View ID="View2" runat="server">
                            ...
                            <cc1:modalpopupextender id="approveP" runat="server"
                            ...
                            <cc1:modalpopupextender id="denyP" runat="server"
                            ...
                            <div style="width: 40%; clear:left; float:left;">
                                                            <h2>Pending User Requests
                                <asp:Button ID="Button3" runat="server" class="btn btn-success" Text="Approve All" OnClick="ApproveAllUser_Click" />
                                <asp:Button ID="Button4" runat="server" class="btn btn-danger" Text="Deny All" OnClick="DenyAllUser_Click" />
                                </h2>
