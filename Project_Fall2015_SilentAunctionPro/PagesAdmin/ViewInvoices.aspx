<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewInvoices.aspx.cs"
    ...
    Inherits="Project_Fall2015_SilentAunctionPro.PagesAdmin.MyInvoices" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"><br /><br /><br /><br /><br />
     ...
     <h2 class="noprint" style="text-align: center; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; border:groove; background:content-box">GET INVOICES</h2>
    ...
    <div class="container">
        ...
        <div style="width: 600px; margin: auto auto" class="noprint">
            <br />
            <p class="lead">Please select a  <i style="color:green;">buyer</i>  from the dropdown menu to view his/her Invoice</p>
            <br />
            
             <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true"
                OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
            </asp:DropDownList>&nbsp;&nbsp;
            <asp:Button ID="getInvoice" runat="server" class="btn btn-sm btn-primary" Text="Get Invoice" OnClick="getInvoice_Click" />
